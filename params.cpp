...
//      none, high school, middle school, elementary (2), day care (4), play group			//remove not when increase by 10.
const double cpcm[TAG] = {0.0000109, 0.0000326, 0.000087, 0.000087, 0.000174}; // community	    //contact rates increased by a factor of 10(not)
const double cpnh[TAG] = {0.0000435, 0.0001305, 0.000348, 0.000348, 0.000696}; // neighborhood   //contact rates increased by a factor of 10(not)
